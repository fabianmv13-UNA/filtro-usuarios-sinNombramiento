...
banner_html = f'<div style="background-color:white; padding:25px 15px; border-radius:10px; border-top: 8px solid #CC0000; display:flex; flex-direction:column; align-items:center; justify-content:center; text-align:center; margin-bottom:25px; box-shadow: 2px 2px 10px rgba(0,0,0,0.15);">{logo_html}<div style="margin-top:15px;"><h1 style="color:#CC0000; margin:0; font-family:\'Segoe UI\', Tahoma, Geneva, Verdana, sans-serif; font-size:32px; font-weight:800; line-height:1.2; letter-spacing:-0.5px;">Universidad Nacional de Costa Rica</h1><p style="color:#222; margin:8px 0 0 0; font-family:\'Segoe UI\', Tahoma, Geneva, Verdana, sans-serif; font-size:22px; font-weight:700;">Producción y Seguridad CGI</p><p style="color:#555; margin:4px 0 0 0; font-family:\'Segoe UI\', Tahoma, Geneva, Verdana, sans-serif; font-size:16px; font-weight:600; letter-spacing:0.5px;">Usuarios SIGESA</p></div></div>'
